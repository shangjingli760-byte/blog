...
export const WovenLightHero = () => {
  ...
  return (
    <div className="relative flex h-[85vh] w-full flex-col items-center justify-center overflow-hidden bg-black dark:bg-white">
      <WovenCanvas />
      <HeroNav />
      ...
      <motion.div
        ...
        className="absolute bottom-8 z-10 flex flex-col items-center gap-2 text-white/60"
      >
        <span className="text-sm" style={{ fontFamily: "'Inter', sans-serif" }}>向下滚动</span>
